    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateAttachment(obj){
                $.post('<?=$_SERVER['PHP_SELF']; ?>', 'cmd=UpdateAttachment&recno='+$('body').data('thisrecno')+'&field='+$(obj).prop('id')+'&value='+$(obj).val()+'&from=announcement', function(result){
                    //alert(result);
                    if(result == 'Failed'){
...
function AcknowledgeAnnouncement()
{
    ...
    $sql = "UPDATE employee_master SET announcement = CONCAT_WS(',', announcement, ".$_POST['recno'].") WHERE recno=".$_SESSION['employee_master_recno'];
